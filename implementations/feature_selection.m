function [ Xtrain Xtest ] = feature_selection(train, test, vocab, count, values)
%feature_selection Summary of this function goes here
%   Detailed explanation goes here

Xtrain = make_sparse(train, count, numel(vocab));
Xtest = make_sparse(test, count, numel(vocab));
X = [Xtrain; Xtest];
